...
namespace csl {
    ...
    mesh_ptr Interpreter::process_mesh(const element& mesh_e) {
        ...
        mesh_ptr result = std::make_shared<oe::mesh>(num_of_vertices, num_of_normals, num_of_triangles, num_of_uvs, max_uv_num);
    ...
    material_ptr Interpreter::process_material(const element& material_e) {
        ...
        result->translucency       = sv_to_float(material_e.single_assignments.at("translucency"));
        result->specular_intensity = sv_to_float(material_e.single_assignments.at("specular_intensity"));
    ...
    oe::tcm_texture Interpreter::process_tcm_texture(const element& tcm_texture_e) {
        ...
        // TODO: Uniform naming convention
        result.textureMulFactor = sv_to_int(tcm_texture_e.single_assignments.at("textureMulFactor"));
    ...
    oe::triangle Interpreter::process_triangle(mesh_ptr mesh, const element& triangle_e, std::size_t num_of_uvs) {
