...
It currently implements a custom file format with asynchronous loading (.csl), a multithreaded pipeline with game logic and renderer running in separate threads, an event handler and an OpenGL 3.3+/ES 2.0+ Renderer using SDL2, GLad and GLM. It can also use ANGLE through SDL2 and translate GL calls to Direct3D 11 for Windows.

Current system requirements:

- **Windows**: D3D11 (Feature level 9_3 seems to be the requirement by ANGLE) or OpenGL ES 2.0
