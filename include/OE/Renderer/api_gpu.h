...
namespace nre { namespace gpu {
    ...
    enum BUFFER_USAGE { DYNAMIC, STATIC, STREAM, NO_REALLOCATION };
    ...
    enum TEXTURE_TYPE { FLOAT, RGBA, RGB10_A2, RGBA16F, SRGBA, RGBA_U16, RGBA_U8, DEPTHSTENCIL };

    enum TEXTURE_FILTER { LINEAR, NEAREST };

    enum FRAMEBUFFER_COPY { FBO_COLOR, FBO_DEPTHSTENCIL, FBO_COLORSTENCIL, FBO_ALL };
