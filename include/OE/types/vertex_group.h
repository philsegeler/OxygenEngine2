 ...
 *  Each instance is assigned a material and a bone id and each instance of these usually gets their own drawcall, unless
 * optimizations are enabled Each instance can also be set to hidden as a result
 */
